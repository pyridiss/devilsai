...
function objectSave()
	return force .. " " .. puissance .. " " .. agilite .. " " .. charisme .. " " .. vitesseAttaque
end

function objectRecoverState(data)
	_, _, force, puissance, agilite, charisme, vitesseAttaque = string.find(data, "(%d+) (%d+) (%d+) (%d+) (%d+)")
end